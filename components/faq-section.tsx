...
const faqs = [
  {
    question: "什么是 LeLo？它是如何工作的?",
    answer:
      "LeLo 是一个综合性的 SaaS 平台，旨在简化您的业务运营流程。它将项目管理、团队协作、数据分析和自动化工具整合在一个统一的仪表板中。只需注册账号、邀请团队成员，即可通过我们直观的界面开始组织您的工作流程。",
  },
  {
    question: "我可以在付费之前试用 LeLo 吗?",
    answer:
      "我们为所有方案提供 14 天免费试用，无需信用卡。在试用期间，您将拥有所有功能的完整访问权限，并且可以随时升级或取消。",
  },
  {
    question: "我的数据在 LeLo 中有多安全?",
    answer:
      "安全是我们的首要任务。我们使用银行级加密技术，符合 SOC 2 Type II 标准，并提供双因素认证、SSO 集成和定期安全审计等功能。您的数据存储在安全、冗余的数据中心，保证 99.9% 的正常运行时间。",
  },
  {
    question: "LeLo 可以与我现有的工具集成吗?",
    answer:
      "可以！LeLo 与 100 多种流行工具集成，包括钉钉、企业微信、飞书、Salesforce、Zapier 等。我们的 API 还允许进行自定义集成，以适应您的特定工作流程需求。",
  },
  {
  ...
  },
  {
    question: "你们提供退款吗?",
    answer:
      "我们为所有付费方案提供 30 天退款保证。如果您在订阅的前 30 天内对 LeLo 不满意，请联系我们的支持团队申请全额退款。",
  },
  {
      ...
      <div className="container mx-auto max-w-4xl">
        <div className="text-center mb-16">
          ...
          <motion.p
            ...
            viewport={{ once: true }}
          >
            关于 LeLo 您需要了解的一切。找不到您要的答案？请联系我们的支持团队
          </motion.p>
        </div>
